    ...
    <>
      <div id='container'>
        ...
        <div className="container_top">
          <p className='heading | main-head lgtBrown'>Your Result</p>

          <div className="circle">
            <p className='result'>76</p>
            <p className='outOf | txt-md lgtBrown'> of 100</p>
          </div>

          <p className="remark">Great</p>
          <p className='txt-md lgtBrown'>You scored higher than 65% of the people who have taken these tests.</p>

        </div>

        <div className="container_bottom">
          <p className='main-head left-algn'>Summary</p>
          <div className='summary-details'>
            ...
            <div className="reaction">
              ...
              <div className='title'>
                <ReactionIcon />
                <p className='txt-md'>Reaction</p>
              </div>

              <p className='txt-md'>80 <span className='lgtBrown'>/ 100</span></p>
            </div>

            <div className="memory">
              <div className='title'>
                <MemoryIcon />
                <p className='txt-md'>Memory</p>
              </div>

              <p className='txt-md'>92 <span className='lgtBrown'>/ 100</span></p>
            </div>
            ...
            <div className="verbal">
              ...
              <div className='title'>
                <VerbalIcon />
                <p className='txt-md'>Verbal</p>
              </div>
              <p className='txt-md'>61 <span className='lgtBrown'>/ 100</span></p>
            ...
            <div className="visual">
              <div className='title'>
                <VisualIcon />
                <p className='txt-md'>Visual</p>
              </div>

              <p className='txt-md'>72 <span className='lgtBrown'>/ 100</span></p>
            </div>
          </div>
